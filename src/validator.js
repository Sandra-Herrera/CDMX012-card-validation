const validator = {
  validateCreditCard: function(creditCardNumber){ //"4213456789542013"
    let arrayCreditCardNumber = Array.from(creditCardNumber); // arrayCreditCardNumber --> ['4', '2', '1', '3', '4', '5', '6', '7', '8', '9', '5', '4', '2', '0', '1', '3']

    for (let index = 0; index < arrayCreditCardNumber.length; index++) {
      arrayCreditCardNumber[index] = parseInt(arrayCreditCardNumber[index]);
    } // arrayCreditCardNumber --> [4, 2, 1, 3, 4, 5, 6, 7, 8, 9, 5, 4, 2, 0, 1, 3]

    arrayCreditCardNumber.reverse(); // arrayCreditCardNumber --> [3, 1, 0, 2, 4, 5, 9, 8, 7, 6, 5, 4, 3, 1, 2, 4]
